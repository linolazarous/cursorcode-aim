        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div>
            ...
            <p className="text-zinc-400 text-lg max-w-md mb-8">
              Get free AI credits to create your first project.
            </p>

            <div className="space-y-4">
              {[
                "Multi-agent AI system powered by advanced models",
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          <Button
            ...
            variant="outline"
            className="w-full h-12 mb-6 bg-white/[0.03] border-white/10 text-white hover:bg-white/[0.07] hover:border-white/20 transition-all"
            data-testid="signup-github-btn"
          >
            {githubLoading ? (
              <Loader2 className="w-5 h-5 animate-spin" />
            ) : (
