      ...
      <main className="flex-1 ml-64">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatsCard title="Total Users" value={stats?.total_users} icon={Users} trend="+12%" trendColor="text-emerald" />
            <StatsCard title="Monthly Revenue" value={`$${stats?.monthly_revenue}`} icon={DollarSign} trend="+8%" trendColor="text-emerald" />
            <StatsCard title="Total Projects" value={stats?.total_projects} icon={BarChart3} trend="" />
            <StatsCard title="AI Generations" value={stats?.total_generations} icon={Activity} trend="" />
          </div>
            ...
            <ChartCard title="AI Usage Trend">
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={usage}>
                  ...
                  />
                  <Line type="monotone" dataKey="generations" stroke="#3B82F6" strokeWidth={2} />
                </LineChart>
              </ResponsiveContainer>
            </ChartCard>
          </div>
            ...
            <CardContent>
              ...
              {totalPages > 1 && (
                <div className="flex justify-end gap-2 mt-4">
                  ...
                  <span className="text-zinc-400 py-2 px-4">{currentPage} / {totalPages}</span>
                  <Button
                    size="sm"
