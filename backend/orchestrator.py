...
# ---------------------------------------------------
AGENT_PROMPTS = {
    "architect": "Design scalable architecture. Include tech stack, database, APIs, and deployment.",
    "frontend": "Generate modern frontend UI using React, Next.js, Tailwind. Ensure responsive design.",
    "backend": "Generate secure backend APIs using FastAPI. Include authentication, DB models, endpoints.",
    "security": "Analyze code for vulnerabilities and suggest fixes.",
    "qa": "Generate automated tests using pytest and integration tests.",
    "devops": "Generate deployment configuration including Docker, CI/CD, and cloud deployment.",
}

# ---------------------------------------------------
# Agent Execution
# ---------------------------------------------------
async def run_agent(api_key: str, agent: str, user_prompt: str, context: str = "") -> str:
...
async def orchestrate_project(api_key: str, prompt: str, user_email: str) -> Dict:
    ...
    execution_log = f"Success: {execution_result['success']}\nOutput:\n{execution_result['output']}\nError:\n{execution_result['error']}"
...
# ---------------------------------------------------
async def stream_orchestration_sse(project_id: str, prompt: str, api_key: str, user_email: str) -> EventSourceResponse:
